...
class BipedCfgWF(BaseConfig):
    class env:
        ...
        # friction, restitution, base mass, base COM, inertia, action delay, IMU offset,
        # Kp scale, Kd scale, motor torque scale, default DOF offset, and push force.
        num_privileged_domain_rand_obs = 1 + 1 + 1 + 3 + 1 + 1 + 4 + num_actions * 4 + 3
        num_critic_observations = 3 + num_observations + num_privileged_domain_rand_obs
...
class BipedCfgNP3OWF(BaseConfig):
    seed = 1
